		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-7 mb-4" style="padding: 0 10px;">
					<div class="container-fluid">
						<div class="about-wrapper row wow fadeInUp">
							...
							<div class="row mt-4">
								<div class="">
									<div class="our-products-wrapper wow fadeInUp" data-wow-delay="0.2s">
										...
										<div class="our-products d-flex flex-lg-row flex-md-row flex-column">
												<h1 class="m-0 our-products-heading my-auto">Our Products</h1>
				...
				<div class="col-md-5" style="padding: 0 10px">
					<div class="">
						<div class="home-info row">
							<div class="">
								<div class="container-fluid">
									<div id="carousel" class="wow fadeInUp h-100 carousel slide carousel-fade" data-ride="carousel" data-wow-delay="0.1s">
										<ol class="carousel-indicators">
				...
				<div class="col-sm-6 mb-4">
					...
					<ol class="carousel-indicators">
					  ...
					  <div class="carousel-inner employees">
					    <div class="carousel-item active">
					       <h1 class="text-center mt-4 mb-2">WE ARE HIRING!</h1>
					       <p class="text-center px-4 pt-1 pb-2">
