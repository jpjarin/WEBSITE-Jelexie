  ...
  <div class="modal-dialog mx-auto" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <img src="assets/img/logo-min-2.png" class="img-fluid pr-3" style="width: 15%">
        <h5 class="modal-title align-self-center" id="exampleModalLabel">Application Form</h5>
      ...
      <div class="modal-body">
        <div class="application-form">
          <form id="application-form" class="" name="application-form">
            <div>

              <div class="form-group w-50">
                <label for="position-desired">Position Desired</label>
                <select class="form-control" id="position-desired" required>
              ...
              <div class="form-group">
                ...
                <label for="personal-information"><strong>Personal Information</strong></label>
                ...
                <div class="form-row text-center mb-2">
                  ...
                  <div class="col-md-10">
                    <div class="form-row">
                      <div class="col-md-6 p-1">
                    <input id="" type="text" name="date-of-birth" required="required" placeholder="Date of Birth" class="form-control">
                  </div>
                  <div class="col-md-6 p-1">
                    <input id="" type="text" name="place-of-birth" required="required" placeholder="Place of Birth" class="form-control">
                  </div>
                    </div>
                  </div>
                </div>
