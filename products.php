					...
					<div class="description">
						...
						<div class="comment-section mt-4">
							<form id="comment-form">
								...
								<textarea name="comment" id="comment" class="form-control" required="required" rows="5" cols="30" placeholder="Comment">Asado Bun: </textarea>
								<button type="submit" class="btn btn-primary mt-2 animated bounceIn" style="animation-delay: 0.5s;" id="">SEND</button>
							</form>
						</div>
					</div>
				</div>
